    ...
    <form class="space-y-5" @submit.prevent="login">
      ...
      <div class="relative my-4">
        ...
        <div class="relative flex justify-center text-sm">
          <span class="bg-app-surface px-2 text-app-text-muted"> ou continue com </span>
        </div>
      </div>
      ...
      <router-link to="/auth/signup" class="text-center block text-sm text-gray-500 hover:text-blue-500 transition">
