...
<template>
  <BaseModal :isOpen="isOpen" :title="modalTitle" size="xl" @close="handleClose">
    <form @submit.prevent="save" id="save-base-data-form" class="space-y-6">
      <div class="space-y-4">
        <h2 class="text-lg font-bold border-b border-app-border pb-2 text-app-text">Informações Gerais</h2>
      ...
      <div class="space-y-4">
        <h2 class="text-lg font-bold border-b border-app-border pb-2 text-app-text">Experiências Profissionais
        </h2>
      ...
      <div class="space-y-4">
        <h2 class="text-lg font-bold border-b border-app-border pb-2 text-app-text">Projetos em Destaque</h2>
