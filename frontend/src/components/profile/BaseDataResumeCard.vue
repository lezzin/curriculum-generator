  ...
  <CardContainer variant="text" size="sm" class="overflow-y-auto space-y-6" :class="height">
    <template v-if="resume">
      ...
      <section v-if="resume.experiences.length">
        ...
        <div v-for="experience in resume.experiences" :key="experience.title" class="space-y-2 border-b pb-3 mb-3">
          <div class="text-sm font-medium">{{ experience.title }} • {{ experience.company }}</div>
