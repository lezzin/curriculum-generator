                    ...
                    <tr v-for="item in props.items" :key="item.id"
                        ...
                        <td class="px-3 py-3">
                            <div class="flex flex-col gap-1">
                                <div class="flex justify-between items-center text-xs text-gray-500">
                                    <span>
                                        {{ item.processed_records ?? 0 }} / {{ item.total_records ?? '?' }} registros
                                    </span>
                        ...
                        <td class="px-3 py-3">
                            <div class="flex gap-2">
                                ...
                                <BaseButton v-if="getStatusConfig(item.status_id).cancel" size="sm"
                                    variant="destructive" :disabled="loadingReportRequest"
