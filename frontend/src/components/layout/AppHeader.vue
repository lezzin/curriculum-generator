        ...
        <AppContainer class="px-8 py-2 h-full">
            <nav class="flex items-center justify-between text-sm font-medium h-[inherit]">
                ...
                <div class="flex items-center gap-8">
                    <router-link :to="{ name: 'Home' }" class="text-gray-600 hover:text-black transition">
                        Início
                    </router-link>
                ...
                <div class="flex items-center gap-4">
                    <BaseButton v-if="!authStore.user?.id" as="router-link" :to="{ name: 'Login' }">
                        Entrar
                    </BaseButton>
                    ...
                    <BaseDropdown v-else>
                        ...
                        <template #default="{ close }">
                            <router-link :to="{ name: 'Profile' }" @click="close" class="dropdown-item">
                                Meu Perfil
                            </router-link>
