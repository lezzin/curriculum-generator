...
* [ ] Remover dados hard-coded utilizados pela IA e permitir que o usuário envie seus próprios dados.
* [ ] Avaliar a possibilidade de utilizar **MinIO** para armazenamento dos dados do usuário.
