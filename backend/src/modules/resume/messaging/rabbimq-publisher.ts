...
export class RabbitMQPublisherService implements OnModuleInit, OnModuleDestroy {
    ...
    private readonly exchange = 'resume-generator-exchange';
    private readonly routingKey = 'resume-generator';
    private readonly queue = 'resume-generator-queue';

    private readonly deadLetterExchange = 'x-dead-letter-exchange-resume-generator';
    private readonly deadLetterQueue = 'resume-generator-dead-letter-queue';
