  ...
  freelance_projects: [
    {
      ...
      problem:
        'Need for an independent platform to sell flashcards integrated with payment provider',
      solution:
        'Custom fullstack platform integrated with Hotmart for payment and affiliate management',
...

    {
      ...
      problem:
        'Create a platform where authors could publish, sell and receive financial support',
      solution:
        'Developed social platform with Stripe integration and Google authentication',
...

    {
      ...
      problem:
        'Automate flashcard generation and implement recurring subscription model',
      solution:
        'Built chatbot system with monthly and yearly subscription using Stripe',
