export const baseResume = {
  ...
  skills: {
    ...
    messaging: ['RabbitMQ', 'Redis (Queues & Cache)', 'Webhooks'],
    databases: ['PostgreSQL', 'MySQL', 'Query Optimization', 'Migrations'],
    infrastructure: [
      'Docker',
  ...
  projects: [
    {
      ...
      impact:
        'Reduced operational risk and improved financial collection efficiency',
